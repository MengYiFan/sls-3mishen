...
if (process.env.NODE_ENV !== "production") {
  ...
  tf = require("/mnt/node_modules/@tensorflow/tfjs-node")
  jpeg = require("/mnt/node_modules/jpeg-js")
  images = require("/mnt/node_modules/images")
...
exports.main_handler = async (event) => {
  ...
  const a = styleImg.toFloat().div(tf.scalar(255)).expandDims() // 张量 & 扩维
